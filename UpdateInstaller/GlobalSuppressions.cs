...
[assembly: SuppressMessage("Minor Code Smell", "S3260:Non-derived \"private\" classes and records should be \"sealed\"", Justification = "<보류 중>", Scope = "type", Target = "~T:UpdateInstaller.Win7Taskbar.Win7TaskbarFunctions.TaskbarList")]
[assembly: SuppressMessage("Minor Code Smell", "S2344:Enumeration type names should not have \"Flags\" or \"Enum\" suffixes", Justification = "<보류 중>", Scope = "type", Target = "~T:UpdateInstaller.Win7Taskbar.ThumbButtonFlags")]
[assembly: SuppressMessage("Minor Code Smell", "S101:Types should be named in PascalCase", Justification = "<보류 중>", Scope = "type", Target = "~T:UpdateInstaller.Win7Taskbar.THUMBBUTTON")]
[assembly: SuppressMessage("Minor Code Smell", "S101:Types should be named in PascalCase", Justification = "<보류 중>", Scope = "type", Target = "~T:UpdateInstaller.Win7Taskbar.RECT")]
[assembly: SuppressMessage("Critical Code Smell", "S3218:Inner class members should not shadow outer class \"static\" or type members", Justification = "<보류 중>", Scope = "type", Target = "~T:UpdateInstaller.Win7Taskbar.Win7TaskbarFunctions.ITaskbarList4")]
